...
const BroughtToYouBy = () => {
  ...
  return (
    <Section backgroundColor={Color.darkblue}>
      <SectionSubtitle color={Color.royalgold} textAlign='center'>Main organizer</SectionSubtitle>
      <div style={{display: 'flex', justifyContent: 'center'}}>
        <img src='./assets/intergalactico-dark.png' width={imgSize} height={imgSize}/>
      </div>
      <SectionSubtitle color={Color.royalgold} textAlign='center'>Partners</SectionSubtitle>
      <div style={{display: 'flex', justifyContent: 'center'}}>
      ...
      <SectionSubtitle color={Color.royalgold} textAlign='center'>Supported by</SectionSubtitle>
      <div style={{display: 'flex', justifyContent: 'center'}}>
